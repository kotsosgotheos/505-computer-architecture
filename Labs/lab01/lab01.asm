...
prog:   # Words ending with ':' are **labels**
        ...
        lw $s0, 0x00($a0)  # The address was previously loaded into a data register
                           # We load the contents of `$a0`
...
###############################################################################
        ...
        #  
matric: .word 4147    # This will be used by your submitted code
var1:   .word 1
